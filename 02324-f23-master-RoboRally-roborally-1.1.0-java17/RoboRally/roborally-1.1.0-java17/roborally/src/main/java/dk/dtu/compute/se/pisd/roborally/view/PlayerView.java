...
public class PlayerView extends Tab implements ViewObserver {
    ...
    public PlayerView(@NotNull GameController gameController, @NotNull Player player) {
        ...
        finishButton.setOnAction( e -> gameController.finishProgrammingPhase());//notImplemented());

        executeButton = new Button("Execute Program");
        executeButton.setOnAction( e-> gameController.executePrograms());//notImplemented());

        stepButton = new Button("Execute Current Register");
        stepButton.setOnAction( e-> gameController.executeStep());//notImplemented());
